<template>
  <form @submit.prevent class="container mx-auto px-4 my-20 max-w-lg" >   
...
export default {
  ...
  methods: {
    ...
    let bal = await getBalance(this.key)
    this.balance = (parseInt(bal) / 1000000000000000000).toFixed(5)
    }
  }
}
</script>
